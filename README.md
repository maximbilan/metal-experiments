...
| <a href="water/"><img src="water/screenshot.jpg" width="160"></a> | [**Water**](water/) | A sunlit swimming-pool lane: waves refract the tiles and lane line, caustics dance on top, raindrops ring the surface, and touching it sends out ripples. One `colorEffect` shader, iOS 17+. |
